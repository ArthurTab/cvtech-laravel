            ...
            <div class="w-full max-w-full px-3 shrink-0 md:w-full md:flex-0">
                <div
                    ...
                    <div class="flex-auto p-6">
                        <div class="flex flex-wrap -mx-3">
                            <form action="{{route('metiers.store')}}" method="post" role="form" class="w-full">
                                <div class="w-full max-w-full px-3 shrink-0 md:flex-0">
                                    @csrf
                                    @method('POST')
                                    <div class="mb-4">
                                        <label for="libelle"
                                               class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 text-white">Libellé</label>
                                        <input name="libelle" value="{{old('libelle')}}"
                                    ...
                                    <div class="mb-4">
                                        <label for="slug"
                                               class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 text-white">Slug</label>
