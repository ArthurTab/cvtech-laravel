            ...
            <div class="w-full max-w-full px-3 shrink-0 md:w-full md:flex-0">
                <div
                    ...
                    <div class="flex-auto p-6">
                        <div class="flex flex-wrap -mx-3">
                            <form action="{{ route('competences.update', $competence->id )}}" method="post" role="form" class="w-full">
                                <div class="w-full max-w-full px-3 shrink-0 md:flex-0">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input name="intitule" value="{{old('intitule', $competence->intitule)}}"
                                    ...
                                    <div class="w-full max-w-full px-3 shrink-0 md:flex-0 mb-4">
                                        ...
                                        <textarea rows="3" name="description"
                                              ...
                                              w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding
                                               ...
                                               placeholder:text-gray-500 focus:border-blue-500 focus:outline-none">{{old('description', $competence->intitule)}}</textarea>
                                        @error('description')
                                        <div class="text-red-500 p-2 text-start w-full mx-6 rounded-lg my-1">{{$message}}</div>
                                        @enderror
                                    </div>
